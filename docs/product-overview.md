...
| **How quickly is the cost of building a comparable home changing?** | Latest monthly year-over-year change in Census's constant-quality construction-cost index, prior-month movement, and the year-over-year change after consumer-price adjustment. | Ten years of monthly year-over-year change, definition and limitations, official methodology, and the separate annual contractor-built price-per-square-foot table. | Supplies a timely 2026 measure of construction-cost pressure without inventing monthly dollars per square foot from an annual benchmark. |
