...
The home page (`/`) contains **26 cards in nine sections**: Growth; Prices; Employment and income; Households; Housing; Business and manufacturing; Financial conditions; Government finances; and Trade and tariffs. The measures update at different frequencies and may point in different directions. No single card is an overall verdict on the economy.
...
- decide which small set of signals best serves the new page’s purpose rather than reproducing all 26 cards;
