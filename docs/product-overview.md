...
The home page (`/`) contains **24 cards in nine sections**: Growth; Prices; Employment and income; Households; Housing; Business and manufacturing; Financial conditions; Government finances; and Trade and tariffs. The measures update at different frequencies and may point in different directions. No single card is an overall verdict on the economy.

The application also has an unlinked secondary-indicators page at `/secondary` and a simplified status board at `/dashboard`. They are supporting presentations, not part of the home-page inventory below. The status board contains 12 tiles: real GDP growth with nominal GDP context; standalone unemployment; payroll growth using the latest complete three-month average with the latest single-month change as secondary context; initial claims using the official four-week average with the latest weekly reading; headline CPI with core CPI context; the market-implied 10-year breakeven inflation rate; the effective federal funds rate with the target-range upper bound; the 10-year-minus-2-year yield spread with 10-year-minus-3-month context; the real-time Sahm Rule indicator; long-term Treasury and mortgage rates; the S&P 500; and the high-yield corporate credit spread. The prices-and-rates row places realized inflation, expected inflation, the policy rate, and the yield curve together. The final markets-and-credit row places long-term borrowing costs, equity drawdown, and credit risk premiums together. Each tile front remains a glanceable status view and flips to a same-size contextual back whose concise explanation responds deterministically to current data and metric-specific rules; no runtime AI commentary is used. The interaction supports pointer, touch, keyboard, and reduced-motion users. The status board does not replace the research-oriented home page.
...
| Card | Compact card | Under **More** | Why it is included |
|---|---|---|---|
| **How quickly are consumer prices rising?** | Latest year-over-year headline CPI-U inflation from the not-seasonally-adjusted All Items index, matching BLS’s standard published 12-month measure; a rule-based plain-language assessment; comparison with a clearly labeled 2% policy reference; and five years over trailing-25-year bands. | Full headline-versus-core CPI evidence and a separate CPI-versus-headline-PCE panel using actual publication months and the Federal Reserve’s formal 2% PCE target, plus controls and documentation. Core CPI remains seasonally adjusted. | Provides the familiar household-facing BLS headline measure while making the seasonal-adjustment convention explicit and distinguishing CPI from the Fed’s preferred PCE measure. |
| **Are workers’ wages keeping up with prices?** | Latest year-over-year real wage growth for private-sector workers, a purchasing-power answer, a historical-position sentence, and a five-year line with zero and trailing-25-year bands. | The larger real-wage chart and controls; nominal wage growth and seasonally adjusted CPI as secondary shared-axis evidence; exact observations, sources, and limitations. | Connects inflation to aggregate purchasing power while avoiding claims about every worker. Seasonally adjusted wage and CPI inputs are paired deliberately; this supporting CPI convention differs from the NSA headline card. |
...
| **Has inflation picked up in recent months?** | The latest rolling three-month annualized headline CPI pace from seasonally adjusted CPIAUCSL versus the preceding non-overlapping three-month pace, including both endpoint rates, their percentage-point difference, a plain-language answer, a two-point slope graphic, and the latest NSA 12-month headline rate as secondary context. | A 24-month rolling three-month annualized seasonally adjusted headline-and-core CPI chart is the primary evidence. Longer 12-month and three-month histories, controls, observations, and methodological cautions remain available as supporting evidence. | Answers whether current inflation momentum accelerated or slowed relative to the immediately preceding period. Seasonal adjustment is appropriate for adjacent-month momentum; the standard BLS 12-month headline remains NSA. The comparison uses complete observed monthly data, treats changes smaller than 0.1 percentage point as little changed, and does not present annualization as a forecast or slower inflation as falling prices. |
...
| **Are employers adding jobs?** | Latest three-month average monthly payroll change, sign and historical-strength language, and a five-year line over bands calculated from the same complete three-month-average series. | Full payroll research chart, controls, and a table pairing monthly changes with three-month averages. | Shows whether employers are adding or cutting jobs and how unusual that pace is. |
...
The current home page is a research-oriented briefing: compact cards make 24 measures scannable, while **More** preserves substantial evidence and documentation. The separately implemented `/dashboard` is simpler still. Its planned tile set is now implemented: GDP growth, unemployment, payroll growth, initial claims, the Sahm Rule, CPI, expected inflation, the effective federal funds rate, the yield curve, long rates with mortgage context, S&P 500 drawdown, and the high-yield credit spread. Their fronts preserve the status scan; their contextual backs explain the live readings with deterministic metric-specific rules and no runtime AI-generated commentary. The S&P hero is explicitly a drawdown from the high in the available committed FRED history—not necessarily an all-time high—and its year-to-date comparison uses the latest valid prior-year-end observation. Treasury and mortgage dates remain independent, and high-yield percentage-point source values are presented as basis points. A separate closeout review may still identify integration polish; this inventory does not claim that review is complete. The page should continue to make explicit what it omits or combines. In particular:

- decide which small set of signals best serves the new page’s purpose rather than reproducing all 24 cards;
