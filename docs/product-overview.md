...
The home page (`/`) contains **23 cards in nine sections**: Growth; Prices; Employment and income; Households; Housing; Business and manufacturing; Financial conditions; Government finances; and Trade and tariffs. The measures update at different frequencies and may point in different directions. No single card is an overall verdict on the economy.
...
| Card | Compact card | Under **More** | Why it is included |
|---|---|---|---|
| **How quickly are consumer prices rising?** | Latest year-over-year headline CPI inflation, a rule-based plain-language assessment, comparison with a clearly labeled 2% policy reference, and five years over trailing-25-year bands. | Full headline-versus-core CPI evidence and a separate CPI-versus-headline-PCE panel using actual publication months and the Federal Reserve’s formal 2% PCE target, plus controls and documentation. | Provides the familiar household-facing inflation measure while distinguishing CPI from the Fed’s preferred PCE measure. |
| **Are workers’ wages keeping up with prices?** | Latest year-over-year real wage growth for private-sector workers, a purchasing-power answer, a historical-position sentence, and a five-year line with zero and trailing-25-year bands. | The larger real-wage chart and controls; nominal wage growth and headline CPI as secondary shared-axis evidence; exact observations, sources, and limitations. | Connects inflation to aggregate purchasing power while avoiding claims about every worker. |
...
| **Has inflation picked up in recent months?** | The latest rolling three-month annualized headline CPI pace versus the preceding non-overlapping three-month pace, including both endpoint rates, their percentage-point difference, a plain-language answer, a two-point slope graphic, and the latest 12-month rate as secondary context. | A 24-month rolling three-month annualized headline-and-core CPI chart is the primary evidence. Longer 12-month and three-month histories, controls, observations, and methodological cautions remain available as supporting evidence. | Answers whether current inflation momentum accelerated or slowed relative to the immediately preceding period. The comparison uses complete observed monthly data, treats changes smaller than 0.1 percentage point as little changed, and does not present annualization as a forecast or slower inflation as falling prices. Core and 12-month CPI are context and cannot override the headline answer. |
