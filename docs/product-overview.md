...
The `/secondary` route retains indicators that are not currently part of the main dashboard for possible future review. It contains the productivity-level card, household-resources card, household debt-burden card, manufacturing output-versus-employment relationship card, industrial-capacity-utilization card, broad credit-conditions card, and bank lending-standards card. The page remains directly accessible but is intentionally omitted from primary navigation.

The separate `/dashboard` route is a simplified status board. Its 12 implemented tiles cover real GDP growth with nominal GDP context; standalone unemployment; payroll growth using the latest complete three-month average with the latest single-month change as secondary context; initial claims using the official four-week average and latest weekly reading; headline CPI with core CPI context; the market-implied 10-year breakeven inflation rate; the effective federal funds rate with the target-range upper bound; the 10-year-minus-2-year yield spread with 10-year-minus-3-month context; the real-time Sahm Rule indicator; long-term Treasury yields with separately dated mortgage-rate context; S&P 500 drawdown from the available committed FRED-history high with year-to-date change; and the high-yield option-adjusted credit spread. The prices-and-rates row places realized inflation, expected inflation, the policy rate, and the yield curve together. The final markets-and-credit row places long-term borrowing costs, equity drawdown, and credit risk premiums together, with the S&P tile spanning two columns. Each tile front remains a glanceable status view and flips to a same-size contextual back whose concise explanation responds deterministically to current data and metric-specific rules; no runtime AI commentary is used. The interaction supports pointer, touch, keyboard, and reduced-motion users. It does not replace the research-oriented home page. The planned tile set is implemented, while a separate final review or closeout story may still remain.
...
| Has inflation picked up in recent months? | The latest rolling three-month annualized headline CPI pace versus the preceding non-overlapping three-month pace, including both endpoint rates, their percentage-point difference, a plain-language answer, a two-point slope graphic, and the latest 12-month rate as secondary context. More leads with a 24-month rolling three-month annualized headline-and-core CPI chart and retains longer 12-month and three-month histories as supporting evidence. | Answers whether current inflation momentum accelerated or slowed relative to the immediately preceding period. The comparison uses complete observed monthly data, treats changes smaller than 0.1 percentage point as little changed, and does not present annualization as a forecast or slower inflation as falling prices. Core and 12-month CPI are context and cannot override the headline answer. |
...
| Are businesses investing more in productive assets? | Latest quarterly year-over-year growth in real private nonresidential fixed investment, shown with five years of readings and bands based on compatible history since 2008. | States whether inflation-adjusted spending on equipment, nonresidential structures, software, and research is higher, lower, or about the same as a year ago; keeps the current historical classification visible and places state-specific confidence and timing context behind **Why this matters**. |
| How large are corporate profits relative to the economy? | Quarterly adjusted after-tax corporate profits divided by nominal GDP, with a five-year compact line and trailing 25-year historical bands. | Keeps the adjusted after-tax profit per $100 of output and current historical classification visible. Structural interpretation of the postwar rise is behind **Why this matters**, while **More** retains the 1947-present research view. It is an economy-wide national-accounts ratio, not an S&P 500 or company revenue margin. |
...
| Card | Displayed measure and chart | Why it is here |
|---|---|---|
| Is the yield curve inverted? | Trailing three-month average of the monthly 10-year Treasury yield minus the 3-month Treasury bill rate, with a five-year compact spread chart and prominent zero line. | Keeps the direct inversion state and a concise curve-shape interpretation visible; recession context is behind **Why this matters**. A negative spread is an inversion, and the relationship is probabilistic. The federal funds rate remains secondary monetary-policy context under **More**. |
...
| Card | Displayed measure and chart | Why it is here |
|---|---|---|
| How large is the federal budget deficit relative to the economy? | The question, unsigned hero, label, five-year compact chart, tooltip, and historical comparison adapt to whether the latest annual result is a deficit, surplus, or approximate balance. The compact chart shows positive active-state magnitude with a marker for every annual observation; its middle-50% and middle-80% bands use only comparable postwar fiscal states. | Identifies the current fiscal state, translates its magnitude into borrowing or excess revenue per $100 of economic output, and classifies it against comparable postwar experience without treating deficits as automatically bad or surpluses as automatically good. **More** explicitly preserves the full signed research series, where deficits are negative and surpluses positive. **Why this matters** retains the state-specific interpretation. This annual flow is distinct from accumulated federal debt. |
| How large is federal debt held by the public relative to the economy? | Quarterly federal debt held outside federal government accounts as a percentage of GDP. The compact view translates the latest ratio into a comparison with one year of economic output, classifies it against postwar history, reports its exact five-year direction, and charts five years over middle-50% and middle-80% bands without a zero line. | Shows accumulated debt rather than the annual deficit’s new borrowing. **Why this matters** explains interest-cost and fiscal-flexibility risks while making clear that history is not a safe range or crisis threshold; **More** preserves the full research history, controls, observations, source, methodology, and limitations. |
