...
Its page header is deliberately minimal: `U.S. Economy` followed by the dashboard date. Section headers contain only their titles; explanatory context belongs inside the relevant cards rather than in introductory paragraphs.
