...
export const freshnessContracts = {
  ...
  'CENSUS-COST': { id: 'CENSUS-COST', provider: 'U.S. Census Bureau and HUD Survey of Construction', contract: { kind: 'release-aware', cadence: 'monthly', automation: 'automatic', graceSuccessfulRefreshCycles: 1, releaseRule: 'Monthly construction price indexes published with New Residential Sales; the two most recent months may be revised' } },
  'CENSUS-CHARS': { id: 'CENSUS-CHARS', provider: 'U.S. Census Bureau and HUD Survey of Construction', contract: { kind: 'release-aware', cadence: 'annual', automation: 'automatic', graceSuccessfulRefreshCycles: 1, releaseRule: 'Annual Characteristics of New Housing publication, generally released in the following year' } },
...
export const visibleDatasetFreshnessRegistry = [
  ...
  dataset('real-hourly-purchasing-power-change-10-year', dataPath('real-hourly-purchasing-power-change-10-year'), ['BLS-EMP', 'BLS-CPI'], R),
  dataset('real-hourly-purchasing-power-change-4-year', dataPath('real-hourly-purchasing-power-change-4-year'), ['BLS-EMP', 'BLS-CPI'], R),
  dataset('real-hourly-purchasing-power-change-20-year', dataPath('real-hourly-purchasing-power-change-20-year'), ['BLS-EMP', 'BLS-CPI'], R),
  dataset('production-worker-hourly-earnings', dataPath('production-worker-hourly-earnings'), ['BLS-EMP'], R),
  dataset('cpi-w-index-seasonally-adjusted', dataPath('cpi-w-index-seasonally-adjusted'), ['BLS-CPI'], R),
  ...
  dataset('single-family-construction-cost-index', dataPath('single-family-construction-cost-index'), ['CENSUS-COST'], R),
  dataset('contractor-built-price-per-square-foot', dataPath('contractor-built-price-per-square-foot'), ['CENSUS-CHARS'], R),
