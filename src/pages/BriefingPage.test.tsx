...
describe('BriefingPage', () => {
  ...
  it('renders one real Labor cell and exactly five inert hidden placeholders', () => {
    ...
    const result = buildLaborBriefing({ unemployment: makeSeries('unemployment-rate', 4), payrolls: makeSeries('payroll-growth', 100), primeAgeEmployment: makeSeries('prime-age-employment-ratio', 75), claims: null }, '2025-01-15')
