...
export function deriveTariffBurdenSeries(customs: EconomicSeries, imports: EconomicSeries, retrievedAt: string, config: TariffBurdenConfig): EconomicSeries {
  ...
  return validateEconomicSeries({
    ...
    description: 'Federal customs-duty receipts divided by imports of goods.', question: 'What share of imported goods is collected as customs duties?', units: 'Percent of goods-import value', frequency: 'quarterly', seasonalAdjustment: 'Seasonally adjusted annual rate (both source levels)', transformation: 'Customs duties divided by goods imports multiplied by 100, calculated by the application', sourceName: 'U.S. Bureau of Economic Analysis via FRED; ratio calculated by the application', sourceUrl: config.customsSource.sourceUrl, retrievedAt,
